...
// enqueue css
function br_common_custom_css(){
    
    wp_enqueue_style( 'br-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= br_opt( 'br_theme_color' ) != '#131313' ? br_opt( 'br_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= br_opt( 'br_book_btn_color' ) != '#131313' ? br_opt('br_book_btn_color') : '';
		$bookBtnHoverBgColor     	= br_opt( 'br_book_btn_hvr_bg_color' ) != '#131313' ? br_opt('br_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = br_opt( 'br_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = br_opt( 'br_navbar_bg_color' ) != '#082b49' ? br_opt( 'br_navbar_bg_color') : '';
		$headerTop_col     		  = br_opt( 'br_top_header_color' );

		$headerTopBg      		  = br_opt( 'br_top_header_bg_color');
		$headerBg          		  = br_opt( 'br_header_bg_color') != '#ffffff' ? br_opt( 'br_header_bg_color') : '';
		$menuColor          	  = br_opt( 'br_header_menu_color' ) != '#131313' ? br_opt('br_header_menu_color') : '';
		$menuHoverColor           = br_opt( 'br_header_menu_hover_color' ) != '#808080' ? br_opt('br_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = br_opt( 'br_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = br_opt( 'br_header_drop_menu_bg_color' ) != '#ffffff' ? br_opt('br_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = br_opt( 'br_dropdown_menu_color' ) != '#131313' ? br_opt('br_dropdown_menu_color') : '';
		$dropMenuHovColor         = br_opt( 'br_dropdown_menu_hover_color' ) != '#808080' ? br_opt('br_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = br_opt( 'br_footer_widget_bg_color' );
		$footerwHeadColor   	  = br_opt('br_footer_widget_heading_color');
		$footerwTextColor   	  = br_opt('br_footer_widget_text_color');
		$footerwanchorcolor 	  = br_opt('br_footer_widget_anchor_color') != '#ffffff' ? br_opt('br_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = br_opt('br_footer_widget_anchor_hover_color') != '#ffffff' ? br_opt('br_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = br_opt('br_fof_bg_color');
		$foftonecolor			  = br_opt('br_fof_textone_color');
		$fofttwocolor			  = br_opt('br_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = br_opt('br_footer_widget_anchor_color') != '#9e9e9e' ? br_opt('br_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .br_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .br_mailchimp_newsletter_widget button
			{
			...
			.form-contact .form-group .btn_1:hover, .lastest_project .section_title .boxed-btn:hover, .messege_area .messege .boxed-btn:hover, .single_sidebar_widget.widget_search .boxed-btn:hover, .comment-form .form-group .boxed-btn:hover, .contact-section .button-contactForm:hover {
    ...
    wp_add_inline_style( 'br-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'br_common_custom_css', 50 );