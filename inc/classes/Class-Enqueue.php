 ...
 */
	...
	class br_Enqueue{
		...
		public function br_scripts_enqueue_init(){
			add_action( 'wp_enqueue_scripts', array( $this, 'br_frontend_enqueue_scripts', ) );
		}

		public function br_frontend_enqueue_scripts( ){
