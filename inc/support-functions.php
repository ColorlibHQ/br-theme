...
function br_post_cats() {
	...
	if ( $cats ) {
		...
		$categories .= '<ul class="nav"><li><span><i class="fa fm fa-th-list"></i>' . esc_html( 'Catagory :', 'br' ) . '</span></li>';
...
// social media
if ( ! function_exists( 'br_social' ) ) {
	function br_social( $args = array() ) {
...
// header cart count
function br_cart_count( $class = '' ) {

	?>
	<div class="header-wrapicon2 <?php echo esc_attr( $class ); ?>">
		<img src="<?php echo esc_url( BR_DIR_ASSETS_URI ); ?>img/icons/icon-header-02.png" class="header-icon1 js-show-header-dropdown" alt="<?php esc_attr_e( 'ICON', 'br' ); ?>">
...
function br_contact7_form_content( $template, $prop ) {
...
add_filter( 'wpcf7_default_template', 'br_contact7_form_content', 10, 2 );