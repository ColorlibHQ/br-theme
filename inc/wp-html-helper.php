...
// image default alt
if ( ! function_exists( 'br_img_default_alt' ) ) {
	function br_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'br_img_tag' ) ) {
	function br_img_tag( array $args ) {
...
// Anchor Tag
if ( ! function_exists( 'br_anchor_tag' ) ) {
	function br_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'br_heading_tag' ) ) {
	function br_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'br_paragraph_tag' ) ) {
	function br_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'br_other_tag' ) ) {
	function br_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'br_button_element ' ) ) {
	function br_button_element( array $args ) {
